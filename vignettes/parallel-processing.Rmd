...
I have six (6) available cores on my machine. I'll set up this tutorial to use all 6 cores. 
...
- __cores:__ The cores that the user has set up. Since we've already set up `doParallel` to use 6 cores, the control recognizes this. 
