...
- __Spark Installation:__ Can be accomplished via `sparklyr::spark_install()`
...
# Register the Spark Backend

Next, we register the Spark Backend using `registerDoSpark()`.
