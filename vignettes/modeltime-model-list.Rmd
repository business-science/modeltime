...
- __Machine Learning Algorithms:__ Boosted ARIMA, or any `parnsip` algorithm
...
param_list_tbl <- tribble(
  ...
  "arima_reg", "auto_arima", "period", "ts(frequency)", "forecast::auto.arima",
  ...
  # arima_reg: arima
  "arima_reg", "arima", "period", "ts(frequency)", "forecast::Arima",
  ...
  "arima_boost", "auto_arima_xgboost", "period", "ts(frequency)", "forecast::auto.arima",
  ...
  # arima_boost: arima
  "arima_boost", "arima_xgboost", "period", "ts(frequency)", "forecast::Arima",
  ...
  # exp_smoothing: ets
  "exp_smoothing", "ets", "period", "ts(frequency)", "forecast::ets",
